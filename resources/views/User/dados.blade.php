...
<div class="panel panel-primary">
    <div class="panel-heading" style="background-color: #dd4b39;">Cadastro de Cliente</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <a href="{{route('users.index')}}" class="btn btn-default"><i class="fas fa-reply"></i> Voltar</a>
